...
class Bunch_Taxonomies
{
	...
	function __construct()
	{
		...
		$this->portfolio_cat_slug = bunch_set($theme_option , 'portfolio_category_permalink' , 'portfolio_category');
	...
	function taxonomies()  {
		/*** Register portfolio taxonomy portfolio_category */
		
		$labels = array(
			'name'                       => _x( 'Category', 'Portfolio Category', BUNCH_NAME ),
		...
		register_taxonomy( 'portfolio_category' , 'bunch_portfolio' , $args );
