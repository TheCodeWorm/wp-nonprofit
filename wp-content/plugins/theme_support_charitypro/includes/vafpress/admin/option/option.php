<?php
return array(
    'title' => __( 'Charity Pro Theme Options', BUNCH_NAME ),
                    ...
                    'controls' => array(
						...
						array(
							...
							'items' =>  array(
										...
										array(
											'value' => 'header_v1',
											'label' => __( 'Header Style 1', BUNCH_NAME ),
										),
							),
							'default' => 'header_v2'
						),
						...
						array(
							...
							'fields' => array(
								...
								array(
									...
									'default' => 'charityproco@gmail.com'
								),
								array(
									'type' => 'textbox',
									'name' => 'address',
									...
									'default' => 'Dhanmond, Dhaka 1230, BD'
								),
								array(
									'type' => 'toggle',
									'name' => 'donate_btn',
									'label' => __( 'Show / Hide Donate Button', BUNCH_NAME ),
									'default' => 0,
									'description' => __('show or hide Donate Button.', BUNCH_NAME)
								),
								array(
									'type' => 'textbox',
									'name' => 'btn_link',
									'label' => __('Donate Button Link', BUNCH_NAME),
									'description' => __('Enter the Donate Button Link.', BUNCH_NAME),
									'default' => '# '
								),
							),
						),
                ...
                array(
                    ...
                    'controls' => array(
						...
						array(
							...
							'default' => 'Copyright &copy; 2017. All Rights Reserved By CharityPro'
						),
                    ) 
                ), //End of submenu
			) 
                 ...
                 array(
                    ...
                    'fields' => array(
						...
						array(
							'type' => 'select',
							'name' => 'social_class',
							'label' => __( 'Choose Icon Background Color', BUNCH_NAME ),
							'items' =>  array(
										array(
											'value' => 'facebook',
											'label' => __( 'Facebook Color', BUNCH_NAME ),
										),
										array(
											'value' => 'twitter',
											'label' => __( 'Twitter Color', BUNCH_NAME ),
										),
										array(
											'value' => 'google-plus',
											'label' => __( 'Google Plus Color', BUNCH_NAME ),
										),
										array(
											'value' => 'linkedin',
											'label' => __( 'Linkedin Color', BUNCH_NAME ),
										),
										array(
											'value' => 'youtube',
											'label' => __( 'Youtube Color', BUNCH_NAME ),
										),
										array(
											'value' => 'skype',
											'label' => __( 'Skype Color', BUNCH_NAME ),
										),
										array(
											'value' => 'pinterest',
											'label' => __( 'Pinterest Color', BUNCH_NAME ),
										),
							),
							'default' => 'header_v1'
						), 
